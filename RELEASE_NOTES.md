Release v0.2.2 — Clean HACS release
...
Notes for reviewers:
- Verify the `custom_components/ai_varme_styring/manifest.json` version matches the changelog (`v0.2.2`).
...
Changelog: see `custom_components/ai_varme_styring/CHANGELOG.md` (v0.2.2).
