...
class AiVarmeCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        pid_kp = float(cfg.get(CONF_PID_KP, DEFAULT_PID_KP))
        pid_ki = float(cfg.get(CONF_PID_KI, DEFAULT_PID_KI))
        pid_kd = float(cfg.get(CONF_PID_KD, DEFAULT_PID_KD))
        pid_deadband_c = float(cfg.get(CONF_PID_DEADBAND_C, DEFAULT_PID_DEADBAND_C))
        pid_integral_limit = float(cfg.get(CONF_PID_INTEGRAL_LIMIT, DEFAULT_PID_INTEGRAL_LIMIT))
        pid_offset_max_c = float(cfg.get(CONF_PID_OFFSET_MAX_C, DEFAULT_PID_OFFSET_MAX_C))
